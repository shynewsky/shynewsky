...
삼성청년SW·AI아카데미에서는 **Python 기반 알고리즘 역량**과 **Web Full Stack** 개발 역량을 강화했으며,<br>**AIoT 및 자율주행(IoT) 프로젝트** 에서 **Jetson, ROS2, Gazebo** 등을 활용해 IoT 소프트웨어 설계 및 구현을 담당하였습니다.

기획·디자인부터 개발까지 **다양한 직무를 경험** 하며 도메인별 전문 용어와 협업 방식을 익혔고,<br>이를 통해 요구사항을 정확히 **분석**하고 기술적으로 **구현**하는 역량과 원활한 **소통** 능력을 갖추게 되었습니다.

초기에는 게임 중심의 프로젝트로 개발 기초를 다졌지만,<br>현재는 **인간과 디지털 기술이 상호작용하는 디지털·IT 산업 전반**에서<br>사용성을 증대시키는 소프트웨어 개발자로 성장하고자 합니다.
...
- 이화여자대학교 융합콘텐츠(BSc)·디자인(BA) 우등 졸업 (2019-2025)
- 한가람고등학교 고급생명·고급영어 교과우수 및 우등상 (2015-2018)
- 국제 바칼로레아(IB) 학교 수학·과학 교과우수 (2009-2014)
...
- UX디자인졸업연구 (2023) - `UrO:둥 - 사진 속 구름을 띄우는 가상하늘 SNS`
- 정보인터렉션디자인 (2022) - `뚜두뭉도 - 트랜스미디어 보물찾기 기획`
- UX디자인 (2022) - `산부인과 - 프라이빗한 접수/소변검사 장소 제공 제안`
- UI디자인 (2021) - `슈퍼루키 - 커리어맵&루키챗 추가로 차별화 전략 제안`
- 사용자연구 (2020) - `노션 - 사용자테스트로 모바일UI 문제 발견 및 개선안 제안`
- 콘텐츠아키텍처링 (2020) - `과제도우미 - 학술 자료 포탈 사이트 기획`
- 메트로휠러 (2019) - `메트로휠러 - 휠채어&유모차를 위한 역 내 길찾기 서비스`
- 디자인의이해 (2019) - `토끼키우기 - 층간소음 예방 데시벨 피드백 인터폰 IoT`

> 교과 프로젝트 - 콘텐츠 기획

- 융합콘텐츠졸업논문 (2023) - `이앙:수선을 꽃피우다 - 퍼즐 비주얼노벨 개발`
- 콘텐츠시스템프로젝트 (2022) - `내가 크툴루의 이상형이라니, 말도 안되잖아?!`
- 디자인익스프레션 (2023) - `QR 코드와 AR RPG를 활용한 홍보 마케팅 아이디어`
- 디지털스토리텔링 (2022) - `불편한편의점 - 인터렉티브 애니메이션 기획·개발`
- 코드플레이 (2023) - `Marble Music - 심리 맞춤 AI 음악 플레이어`
- 디지털그래픽스 (2022)  - `골든타임 - 의료 사각지대 경각심을 제기하는 웹디자인`
- 디지털그래픽스 (2022) - `AR동물원 - 동물 전시를 예방하는 AR 동물원 콘텐츠`
- 크리에이티브라이팅 (2021) - `진달래 - 이데올로기 악령을 퇴치하는 엑소시스트 세계관`
- 일본콘텐츠투어리즘 (2020) - `나도!런닝맨 - 성지순례를 활용한 전국 관광 활성화 콘텐츠`
- 디지털스토리텔링개론 (2019) - `헨젤엔그레텔 - 인터렉티브 스토리텔링 각색`

> 교과 프로젝트 - 시각 디자인

- 디자인아트졸업연구 (2023) - `Vtuber - 퍼스널브랜딩 생태계 및 IP전략 연구`
- 그래픽디자인 (2023) - `학교생활 - 학교폭력을 재미로 승화시킨 놀이북`
- 머테리얼플레이 (2023) - `단성 - 고온파라핀과 양모펠트를 활용한 재료 연구`
- 환경색채학 (2022) - `서울갈산초등학교 - 주변 환경에 어울리는 외벽 리디자인`
- 디자인리서치 (2022) - `인체 비율을 적용한 캐릭터 원화용 체형 리서치 북`
- 타이포그래피 (2020) - `빗방울체 - 영화 '날씨의아이'를 모티프로 한 폰트 개발`

> 교외활동 - 게임개발

- 쥬신아카데미 게임 모작 (2025) - `메이플스토리`,`리플이펙트`
- Tumblbug 펀딩 및 STEAM 출시 (2023) - `물멍키트`
- 넥슨 슈퍼해커톤 참여 (2022) - `빙의:육체쟁탈전`
- 스마일게이트 슬기로운 데모생활 (2022) - `카투바의 밀렵꾼`, `스태퍼케이스` 베스트테스터
- 스마일게이트 온라인게임잼 참여 (2022) - `봄날의프로포즈`,`힛더그린`,`모노스키아`
- 전국게임제작동아리 GameMakers 6기 (2022) - `미자르와 알고르의 사건수첩`
- 대학연합게임제작동아리 Bridge 8기 (2020) - `할망`

> 교외활동 - 일러스트레이터

- 목포 쿠레레 갤러리 단체전 (2025) - `POETRY OF COLORS : 색감의 시`
- 신도림 현대백화점 단체전 (2025) - `SERENDIPITY:세렌디피티`
- 김해 도슨트갤러리 단체전 (2025) - `발랜타인:VALENTINE` 
- 충정로 붐박스 단체전 (2025) - `아날로그 웨이브:아임,그리다` 
- 네이버 스티커 출시 (2024) - `묘호티콘1 - 희노애락` 
- 작가와 무료표지 9종 기부 (2024) - `태양이 거실벽에 추상화를 그린다`
- 압구정 빈칸 일러닷 참여 (2023) - `서묘호`
- 디지털드로잉 아트스터디 참여 (2022)

> 교외활동 - SNS

- Threads `서묘호` (2023-2025) - RVC·UVR5 활용 AI Cover 연구
- Instagram `서묘호` (2020-2025) - 캐릭터 디자인 및 MMD 콘텐츠 연구
- Youtube `메이플1분요약` (2020-2025) - 비디오 165개, 쇼츠 129개, 라이브 319회
- Youtube `이화그린걸즈` (2021) - 1,2화 제작
- Youtube `이화여대 수강신청 튜토리얼` 제작 (2020,2022)
- 이화여대 제 51대 총학생회 `Enable` 문화기획국 (2019)
...
[이화여대 신산업융합대학 융합콘텐츠학과 소개 링크](https://cc.ewha.ac.kr/cc/intro/department-overview.do)

**융합콘텐츠학과**는 4차 산업의 첨단 기술을 활용하여 콘텐츠·서비스·시스템의 기획·디자인·개발을 모두 아우르는 융합형 인재를 양성하는 학과입니다.<br>
개발 역량을 기르고자 `콘텐츠SW트랙`을 선택하였고, 추가로 디자인 역량을 기르고자 **디자인학부**을 복수전공 하였으나,<br>
신설 학과의 교과과정 운영 미숙으로 인해, 졸업 직전에 개발 트랙은 폐쇄되었고 `UX기획및디자인트랙`과 `콘텐츠서비스&기획트랙`만 이수하게 되었습니다.<br>
학부시절 5년간 프로그래밍을 독학하였지만, 제대로 된 교과과정에 대한 아쉬움으로 **쥬신아카데미**와 **삼성청년SW·AI아카데미**에 입과하였습니다.<br>

> 본인의 강단점이 무엇인가요?

제 강점은 **몰입력** 이라고 생각합니다.<br>한번 작업을 시작하면, 밥과 잠을 잊고 최대 8시간 집중할 정도로 무아지경에 빠지는데, 이 시간 동안 제게 주어진 일에 대해 스스로 꼬리 질문을 하며 기초부터 체계적으로 쌓아올리는 구조를 설계하고 검토합니다. 최대한 스스로 해결하고자 하며, 팀원과 상의할 내용이 있다면, 질문 리스트와 경우에 따른 대안을 준비하여 회의 한번에 결정을 완료하여 작업의 효율을 높이고자 합니다.

제 단점은 **완벽주의** 라고 생각합니다.<br>실수에 대한 두려움이 커, 아무리 애자일하게 개발을 진행하고자 해도, 무의식적으로 사전 조사와 설계를 깊게 진행하려고 하는 것 같습니다. 제 단점을 온전히 극복하는 것은 어렵지만, 혹시나 MVP를 개발할 때 깊게 고민하는 것 같다고 자각하게 되면 `계속해서 고쳐나가면 돼` 라고 생각하며 결과물에 대한 부담감을 덜어놓으려고 하고 있습니다.

> 몰입력은 언제 깨지나요?

**현실** 과 부딪히면 몰입이 깨지는 것 같습니다.<br>음악을 좋아하여 9년간 피아노를 치며 연주회도 하고 작곡도 독학했었지만, 실질적으로 피아니스트를 직업으로 삼기엔 재능이 부족하여 포기했었습니다.<br>동물을 좋아하여 7년간 생명과학과를 가고자 관련 책을 많이 읽었지만, 연구를 위해 동물 실험을 해야한다는 점에서 괴리감을 느끼며 포기했습니다.<br>메이플스토리IP를 좋아하여 5년간 메이플스토리 요약 유튜브를 운영하였지만, 더 이상 레벨을 올려 스토리를 보기 어려워져 중단하였습니다.<br>캐릭터디자인으로 창업하고자 6년간 일러스트레이터 활동을 해보았지만, 선천적인 미적 감각의 한계를 느껴 그만두게 되었습니다<br>그 외에도 여러 활동에 몰입하였으나, 현실적인 상황과 선천적인 재능에 한계를 느껴 중단하게 되었던 것 같습니다.

> 취미와 특기는 무엇인가요?

취미는 **전자제품 분해** 입니다.<br>지인들에게서 더 이상 사용하기 어려운 폰, 태블릿, 노트북 등을 받아 분해하고, 고장난 부품을 교체하여 새로운 생명을 주는 것에 희열은 느끼고 있습니다.<br><br>특기는 **목소리 연기** 입니다.<br>스토리 속 상황을 이해하고 캐릭터 감정에 이입하여 서로 다른 목소리로 대사를 읊는 것을 잘하여 인터넷 방송에서 더빙을 진행하곤 하였습니다.
