...
**융합콘텐츠학과**는 4차 산업의 첨단 기술을 활용하여 콘텐츠·서비스·시스템의 기획·디자인·개발을 모두 아우르는 융합형 인재를 양성하는 학과입니다.<br><br>
개발 역량을 기르고자 `콘텐츠SW트랙`을 선택하였고, 추가로 디자인 역량을 기르고자 **디자인학부**을 복수전공 하였으나, 신설 학과의 교과과정 운영 미숙으로 인해, 졸업 직전에 개발 트랙은 폐쇄되었고 `UX기획및디자인트랙`과 `콘텐츠서비스&기획트랙`만 이수하게 되었습니다. 학부시절 5년간 프로그래밍을 독학하였지만, 제대로 된 교과과정에 대한 아쉬움으로 **쥬신아카데미**와 **삼성청년SW·AI아카데미**에 입과하였습니다.

> 본인의 장단점이 무엇인가요?

제 장점은 **몰입력** 이라고 생각합니다.<br>한번 작업을 시작하면, 밥과 잠을 잊고 최대 8시간 집중할 정도로 무아지경에 빠지는데, 이 시간 동안 제게 주어진 일에 대해 스스로 꼬리 질문을 하며 기초부터 체계적으로 쌓아올리는 구조를 설계하고 검토합니다. 최대한 스스로 해결하고자 하며, 팀원과 상의할 내용이 있다면, 질문 리스트와 경우에 따른 대안을 준비하여 회의 한번에 결정을 완료하여 작업의 효율을 높이고자 합니다.<br><br>제 단점은 **완벽주의** 라고 생각합니다.<br>실수에 대한 두려움이 커, 아무리 애자일하게 개발을 진행하고자 해도, 무의식적으로 사전 조사와 설계를 깊게 진행하려고 하는 것 같습니다. 제 단점을 온전히 극복하는 것은 어렵지만, 혹시나 MVP를 개발할 때 깊게 고민하는 것 같다고 자각하게 되면 `계속해서 고쳐나가면 돼` 라고 생각하며 결과물에 대한 부담감을 덜어놓으려고 하고 있습니다.

> 몰입력은 언제 깨지나요?

**현실** 과 부딪히면 몰입이 깨지는 것 같습니다.<br><br>음악을 좋아하여 9년간 피아노를 치며 연주회도 하고 작곡도 독학했었지만, 실질적으로 피아니스트를 직업으로 삼기엔 재능이 부족하여 포기했었습니다. 동물을 좋아하여 7년간 생명과학과를 가고자 관련 책을 많이 읽었지만, 연구를 위해 동물 실험을 해야한다는 점에서 괴리감을 느끼며 포기했습니다. 메이플스토리IP를 좋아하여 5년간 메이플스토리 요약 유튜브를 운영하였지만, 더 이상 레벨을 올려 스토리를 보기 어려워져 중단하였습니다. 캐릭터디자인으로 창업하고자 6년간 일러스트레이터 활동을 해보았지만, 선천적인 미적 감각의 한계를 느껴 그만두게 되었습니다. 그 외에도 여러 활동에 몰입하였으나, 현실적인 상황과 선천적인 재능에 한계를 느껴 중단하게 되었던 것 같습니다.

> 취미와 특기는 무엇인가요?

취미는 **전자제품 분해** 입니다.<br>지인들에게서 더 이상 사용하기 어려운 전자제품을 받아 분해하고, 고장난 부품을 교체하여 새로운 생명을 주는 것에 희열은 느낍니다.<br><br>특기는 **목소리 연기** 입니다.<br>스토리 속 상황을 이해하고 캐릭터 감정에 이입하여 서로 다른 목소리로 대사를 읊는 것을 잘하여 인터넷 방송에서 더빙을 진행하곤 하였습니다.
