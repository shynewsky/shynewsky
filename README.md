...
# 임베디드·로봇 SW 엔지니어【 양새하 】입니다.

융합콘텐츠학과에서 **첨단기술 산업** 과 **Human-Computer Interaction(HCI)** 에 대한 관심을 바탕으로<br>40여 개의 기획·디자인 프로젝트를 수행하며 프로토타이핑을 넘어 **실제로 동작하는 시스템을 구현하고 싶다는 목표** 가 생겼고,<br>이를 위해 쥬신아카데미와 삼성청년SW·AI아카데미에 입과하여 본격적으로 개발 역량을 쌓았습니다.

삼성청년SW·AI아카데미에서는 Python 기반 알고리즘 역량을 강화했으며,<br>**AIoT 및 자율주행(IoT) 프로젝트** 에서 Jetson, Raspberry Pi, ROS2 등을 활용해<br>IoT 소프트웨어 설계 및 구현을 담당하였습니다.

기획·디자인부터 개발까지 **다양한 직무를 경험** 하며 도메인별 전문 용어와 협업 방식을 익혔고,<br>이를 통해 요구사항을 정확히 **분석**하고 기술적으로 **구현**하는 역량과 원활한 **소통** 능력을 갖추게 되었습니다.

초기에는 게임 중심의 프로젝트로 개발 기초를 다졌지만,<br>현재는 **인간과 디지털 기술이 상호작용하는 임베디드·로봇 및 AIoT 산업 전반**에서<br>센서 데이터 처리부터 제어 로직 구현까지 수행하는 임베디드 엔지니어로 성장하고자 합니다.
