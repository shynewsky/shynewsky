...
삼성청년SW·AI아카데미에서는 **Python 기반 알고리즘 역량**과 Web Full Stack 개발 역량을 강화했으며,<br>**AIoT 및 자율주행(IoT) 프로젝트** 에서 Jetson, Raspberry Pi, ROS2 등을 활용해 IoT 소프트웨어 설계 및 구현을 담당하였습니다.
...
- 스마일게이트 슬기로운 데모생활 (2022) - `카투바의 밀렵꾼`, `스태퍼케이스` 베스트테스터 선정
