...
융합콘텐츠학과에서 **첨단기술 산업과 Human-Computer Interaction(HCI)**에 대한 관심을 바탕으로<br>40여 개의 기획·디자인 프로젝트를 수행하였습니다.

프로토타이핑을 넘어 실제로 동작하는 시스템을 구현하고 싶다는 목표가 생겼고,<br>이를 위해 쥬신아카데미와 삼성청년SW·AI아카데미에 입과하여 본격적으로 개발 역량을 쌓았습니다.
...
초기에는 게임 중심의 프로젝트로 개발 기초를 다졌지만,<br>현재는 인간과 디지털 기술이 상호작용하는 임베디드·로봇 및 AIoT 산업 전반에서<br>실질적인 가치를 만드는 엔지니어로 성장하고자 합니다.
