...
**다양한 분야와 직무를 경험**하며 도메인과 직무별 전문 용어를 터득함으로써 **소통 능력**을 길렀고, <br>**요구사항을 정확하게 파악하여 작업을 진행**할 수 있게 되었습니다.
...
- <strong>AI/IOT</strong> : SSAFY AIoT·IOT(자율주행) 트랙 이수 (2026)
