...
> 다양한 선택지 속에서 프로젝트에 맞는 방향을 판단하고, 기획 의도를 구현까지 연결하는 개발자로 성장하고자 합니다.
...
삼성청년SW·AI아카데미에서는 **Python 기반 알고리즘 역량**과 **Web Full Stack** 개발 역량을 강화했으며,<br>**AIoT 및 자율주행(IoT) 프로젝트** 에서 **Jetson, Raspberry Pi, ROS2, Gazebo** 등을 활용해 IoT 소프트웨어 설계 및 구현을 담당하였습니다.
